...
public class ActivityInsurancePayment extends AppCompatActivity {
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selected_ins_id == -1 || selected_pay_id == -1) {
                    Toast.makeText(ActivityInsurancePayment.this, "missing selection", Toast.LENGTH_LONG).show();
                }
                else {
                    String insurance = "";
                    String payment = "";
                    ...
                    Util.goToMain(ActivityInsurancePayment.this);
                }
            }
        });
    }
